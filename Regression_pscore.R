...
#to plot observed vs predicted (training data)
pred_zeroinfl_spline <- predict(zinb_spline4, type = "response")
plot_data <- data.frame(
  observed = score_data$partnership_score,
  predicted = pred_zeroinfl_spline
)
...
# Create grid of partnership combinations
